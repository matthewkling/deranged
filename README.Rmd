...
```
The result is an array of adult populations over space and time. The plots below show population time series for 10 random grid cells, and snapshots of spatial population patterns over time.  

```{r timeseries, message = FALSE, echo = FALSE}
library(tidyverse)
